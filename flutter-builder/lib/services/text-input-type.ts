...
export class TextInputType extends EnumClass {
  ...
  static readonly emailAddress = EnumField.fromStatic(
  ...
  static readonly streetAddress = EnumField.fromStatic(
  ...
  static readonly visiblePassword = EnumField.fromStatic(
