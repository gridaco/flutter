...
export interface AnalysisGetLibraryDependenciesResponse {
   ...
   */
  packageMap: {
    [key: string]: { [key: string]: FilePath[] | undefined } | undefined;
  };
}
 ...
 */
export type ExecutableKind = "CLIENT" | "EITHER" | "NOT_EXECUTABLE" | "SERVER";
 ...
 */
export type CompletionService = "AVAILABLE_SUGGESTION_SETS";
 ...
 * domain.
 */
export type ExecutionService = "LAUNCH_DATA";

/**
 * An enumeration of the kinds of files.
 */
export type FileKind = "LIBRARY" | "PART";
 ...
 * are related to a specific list of files.
 */
export type FlutterService = "OUTLINE";
 ...
 */
export type GeneralAnalysisService = "ANALYZED_FILES";
 ...
 */
export type ServerService = "LOG" | "STATUS";
 ...
 */
export type AnalysisErrorSeverity = "INFO" | "WARNING" | "ERROR";
 ...
 */
export type RefactoringProblemSeverity = "INFO" | "WARNING" | "ERROR" | "FATAL";
