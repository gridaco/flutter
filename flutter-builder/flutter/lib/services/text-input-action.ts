...
export class TextInputAction extends EnumClass {
    static readonly continueAction = EnumField.fromStatic('TextInputAction.continueAction')
    static readonly done = EnumField.fromStatic('TextInputAction.done')
    static readonly emergencyCall = EnumField.fromStatic('TextInputAction.emergencyCall')
    ...
    static readonly unspecified = EnumField.fromStatic('TextInputAction.unspecified')
