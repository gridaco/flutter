...
extension StringExtensionForEnums on String {
  ...
  AndroidOverscrollIndicator parseAndroidOverscrollIndicator(){
    return AndroidOverscrollIndicator.values
      .firstWhere((e) => e.toString() == 'AndroidOverscrollIndicator.' + this);
  }
  ...
  Axis parseAxis(){
    return Axis.values
      .firstWhere((e) => e.toString() == 'Axis.' + this);
  }
  ...
  BoxFit parseBoxFit(){
    return BoxFit.values
      .firstWhere((e) => e.toString() == 'BoxFit.' + this);
  }
  ...
  Clip parseClip(){
    return Clip.values
      .firstWhere((e) => e.toString() == 'Clip.' + this);
  }
  ...
  CupertinoUserInterfaceLevelData parseCupertinoUserInterfaceLevelData(){
    return CupertinoUserInterfaceLevelData.values
      .firstWhere((e) => e.toString() == 'CupertinoUserInterfaceLevelData.' + this);
  }
  ...
  FlexFit parseFlexFit(){
    return FlexFit.values
      .firstWhere((e) => e.toString() == 'FlexFit.' + this);
  }
  ...
  PlatformProvidedMenuItemType parsePlatformProvidedMenuItemType(){
    return PlatformProvidedMenuItemType.values
      .firstWhere((e) => e.toString() == 'PlatformProvidedMenuItemType.' + this);
  }
  ...
  RouteInformationReportingType parseRouteInformationReportingType(){
    return RouteInformationReportingType.values
      .firstWhere((e) => e.toString() == 'RouteInformationReportingType.' + this);
  }
  ...
  ScrollPositionAlignmentPolicy parseScrollPositionAlignmentPolicy(){
    return ScrollPositionAlignmentPolicy.values
      .firstWhere((e) => e.toString() == 'ScrollPositionAlignmentPolicy.' + this);
  }
  

  ScrollViewKeyboardDismissBehavior parseScrollViewKeyboardDismissBehavior(){
    return ScrollViewKeyboardDismissBehavior.values
      .firstWhere((e) => e.toString() == 'ScrollViewKeyboardDismissBehavior.' + this);
  }
  ...
  TableCellVerticalAlignment parseTableCellVerticalAlignment(){
    return TableCellVerticalAlignment.values
      .firstWhere((e) => e.toString() == 'TableCellVerticalAlignment.' + this);
  }
  ...
  BottomNavigationBarLandscapeLayout parseBottomNavigationBarLandscapeLayout(){
    return BottomNavigationBarLandscapeLayout.values
      .firstWhere((e) => e.toString() == 'BottomNavigationBarLandscapeLayout.' + this);
  }
  ...
  MaterialBannerClosedReason parseMaterialBannerClosedReason(){
    return MaterialBannerClosedReason.values
      .firstWhere((e) => e.toString() == 'MaterialBannerClosedReason.' + this);
  }
  ...
  NavigationDestinationLabelBehavior parseNavigationDestinationLabelBehavior(){
    return NavigationDestinationLabelBehavior.values
      .firstWhere((e) => e.toString() == 'NavigationDestinationLabelBehavior.' + this);
  }
  ...
  RefreshIndicatorTriggerMode parseRefreshIndicatorTriggerMode(){
    return RefreshIndicatorTriggerMode.values
      .firstWhere((e) => e.toString() == 'RefreshIndicatorTriggerMode.' + this);
  }
  ...
  Thumb parseThumb(){
    return Thumb.values
      .firstWhere((e) => e.toString() == 'Thumb.' + this);
  }
  ...
  PlatformViewHitTestBehavior parsePlatformViewHitTestBehavior(){
    return PlatformViewHitTestBehavior.values
      .firstWhere((e) => e.toString() == 'PlatformViewHitTestBehavior.' + this);
  }
  ...
  ClipOp parseClipOp(){
    return ClipOp.values
      .firstWhere((e) => e.toString() == 'ClipOp.' + this);
  }
  ...
  HttpClientResponseCompressionState parseHttpClientResponseCompressionState(){
    return HttpClientResponseCompressionState.values
      .firstWhere((e) => e.toString() == 'HttpClientResponseCompressionState.' + this);
  }
